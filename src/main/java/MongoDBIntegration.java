...
public class MongoDBIntegration {
    public static void main(String[] args) {
        MongoClient mongoClient = MongoClients.create("mongodb+srv://root:root@showbts.mwath.mongodb.net/?retryWrites=true&w=majority&appName=ShowBts");

        MongoDatabase database = mongoClient.getDatabase("ShowBts");
